const prompt = require("../../source/node_modules/prompt-sync")({ sigint: true });
const Crypto = require("crypto")
const Wallet = require("../../source/Wallet.js")
const AppConfig = require("../../source/AppConfig.js")
const chalk = require('../../source/node_modules/chalk');
var port
var LOGGED_IN = false
...
async function send_transaction(receiver, amount){
    ...
    fs.writeFile('./tran_base', JSON.stringify(payload), err => {
        if (err) {
        console.error(err);
        } else {
