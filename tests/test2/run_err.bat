...
::bridge OFF (disconnect subnets)
curl 127.0.0.1:5002/pause


:: ======================= Tip: manipulate n of loops to cause network to adapt to other subnet
:: Default net1: 7 and net2: 5 forces network to adapt to net1 
...
::Bridge ON (networks connected again)
curl 127.0.0.1:5002/pause

::Cause synchronization by sending new transactions
::Sends 3 instead of 1 to give higher chance that temporary forks won't cause issues with /balance
node ..\..\source\ATM.js -t 5001 main main d7efc89cec74445da79519622386c215bb09142ed4cd01ea8b194a026294df43 1
node ..\..\source\ATM.js -t 5001 main main d7efc89cec74445da79519622386c215bb09142ed4cd01ea8b194a026294df43 1
node ..\..\source\ATM.js -t 5001 main main d7efc89cec74445da79519622386c215bb09142ed4cd01ea8b194a026294df43 1